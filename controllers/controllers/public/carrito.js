                    ...
                    data.map(function (row) {
                        ...
                        <div class="row">
                            ...
                            <div class="col s12" id="fondocompra-carrito1">
                                <!--Icono de eliminar-->
                                <div class="elimardel-carrito" onclick="delDet(${row.id_detalle_pedidos},${row.id_pedidos_establecidos},${row.cantidad_detallep},${row.fk_id_producto})">
...
function delDet(id,idp,cant,idprd){
    const data = new FormData();
    data.append('id', id);
    data.append('idp', idp);
    data.append('idprd', idprd);
