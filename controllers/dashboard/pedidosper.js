...
const API_PEDIDOE = SERVER + 'dashboard/pedidosper.php?action=';
        ...
        <div class="col l3 s12 m6">
                    ...
                    <div class="card" id="tarjetas-privado">
                        ...
                        <div class="botones">
                            ...
                            <!--Botón aceptado-->
                            <a onclick= "dePediP(${row.id_pedidos_personalizado})"   class="waves-effect btn-floating waves-light btn modal-trigger grey" href="#modalaceptar"><i
...
function obtenerFechasR(){
    ...
    if (formValues) {
        ...
        let url = SERVER + 'reports/dashboard/pedidosperFX.php';
