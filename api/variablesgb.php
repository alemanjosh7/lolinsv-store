...
PIN = El pin para restablecer contraseñas
horaPIN = La hora en la que se creo el pin, este solo será una vez
cantidad
*/
    ...
    switch ($_GET['action']) {
        ...
        case 'getIdProducto':
            if (isset($_SESSION['id_producto'])) {
                ...
                $result['exception'] = 'No se ha seteado el id del producto';
            }
            break;
        case 'setIdProducto':
            $result['status'] = 1;
