...
class Clientes extends Validator
{
    ...
    */
    ...
    {
        $sql = 'select c.nombre_cliente,c.apellido_cliente, cast(sum(pe.montototal_pedidoesta) as decimal) suma
                from pedidos_establecidos as pe inner join clientes as c ON pe.fk_id_cliente = c.id_cliente 
                where c.fk_id_estado != 10
                group by c.nombre_cliente,c.apellido_cliente order by suma desc limit 5';
        $params = null;
        return Database::getRows($sql, $params);
    }
}
