...
class Productos extends Validator
{
    ...
    */
    ...
    //Obtener productos y ordenarlos dependiendo de la elección del reporte
    public function reporteCantFilt($filt)
    {
    ...
    //Obtener el listado con los productos con menor cantidad
    public function graficaProductosCM()
    {
        $sql = 'SELECT cantidad, nombre_producto FROM productos WHERE cantidad >= 0 ORDER BY cantidad ASC LIMIT 10';   
        $params = null;
        return Database::getRows($sql, $params);
    }

    //Obtener la cantidad de producto por categoria
    public function graficaCatNP()
    {
        $sql = 'SELECT nombre_categoria, COUNT(id_producto) cantidad
                FROM productos AS prd
                RIGHT JOIN categorias AS cat ON prd.fk_id_categoria = cat.id_categoria
